...
async function init() {
  ...
  if (!roles.includes('admin') && !hasBeatUploadPermission) { introElement.textContent = 'Acceso restringido.'; renderEmpty('Tu cuenta no tiene permiso para administrar sus beats.'); return; }
  state.user = account;
